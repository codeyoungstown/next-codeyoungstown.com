...
export const jobs: Job[] = [
  ...
  {
    title: "Software Engineer, Patient Experience",
    company: "FlyteHealth",
    desc: "Build patient-facing experiences for FlyteHealth’s cardiometabolic platform by designing and maintaining scalable features, collaborating on AI-enabled workflows, and ensuring data quality, security, and HIPAA-compliant systems that support better clinical outcomes. Languages/Skills: React, React Native/Expo, Node.js/Express, TypeScript, JavaScript, relational databases, HIPAA-compliant systems, and AI-enabled workflows.",
    location: "Remote (United States)",
    salary: "$120K - $150K",
    listing: "https://www.linkedin.com/jobs/view/4369496754/",
    date: "2026-02-07",
  },
  {
    title: "Software Engineer, Care Delivery",
    company: "FlyteHealth",
    desc: "Develop core care-delivery experiences by building scalable product features, collaborating with product partners on patient engagement improvements, and implementing secure, observable systems that support healthcare compliance. Languages/Skills: React, React Native/Expo, Node.js/Express, TypeScript, JavaScript, relational databases, HIPAA-compliant systems, and observability tooling.",
    location: "Remote (United States)",
    salary: "$120K - $150K",
    listing: "https://www.linkedin.com/jobs/view/4369497523/",
    date: "2026-02-07",
  },
  {
    title: "DevOps Manager",
